            ...
            <div class="row clearfix">
                ...
                <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="count-box">
                        ...
                        <h4 class="counter-title">Festival</h4>
                    </div>
                </div>
                ...
                <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    <div class="count-box">
                        ...
                        <h4 class="counter-title">Films Published</h4>
                    </div>
                </div>
                ...
                <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                    <div class="count-box">
                        ...
                        <span class="count-text" data-speed="3000" data-stop="189">0</span>
                ...
                <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="1200ms">
                    <div class="count-box">
                        ...
                        <span class="count-text" data-speed="3000" data-stop="7342">0</span>
                        <h4 class="counter-title">Audience Attend</h4>
                    </div>
                </div>
            </div>
        </div>
